...
ggplot(data = plot_usagers, aes(x=age, y=count, fill=grav)) +
  geom_bar(stat="identity") + geom_smooth(se=FALSE, color = "orange") + ggtitle("Effectif des accidents mortels par âge");
...
ggplot(sub_df, aes(x = age, fill = factor(grav))) +
  ...
  scale_fill_discrete(name = "Gravité de l'accident",
                      labels = c("Indemne", "Blessé léger", "Blessé hospitalisé", "Tué")) + ggtitle("Densité des accidents par âge des personnes touchées")
