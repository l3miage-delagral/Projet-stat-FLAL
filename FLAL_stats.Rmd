...
# Enlever les accents et caracteres spéciaux
df_region$region <- iconv(df_region$region, from = "ISO-8859-1", to = "UTF-8")
df_region$region <- sub("Ã´", "ô", df_region$region)
df_region$region <- sub("Ã©", "é", df_region$region)
df_region$region <- sub("Ã", "î", df_region$region)
