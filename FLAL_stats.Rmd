...
ggplot(df_secu, aes(x = secu1, fill = grav)) + 
  geom_bar(position = "fill") +
  facet_grid(. ~ grav, scales = "free_y", space = "free_y") +
  scale_x_reordered() +
  labs(x = "Équipements de sécurité", y = "Proportion d'accidents") +
...
colors <- c("Plein jour"="yellow", 
        ...
        "Nuit sans éclairage public"="black",
        "Nuit avec éclairage public non allumé"="blue",
